        ...
        <div v-else>
          <el-form-item v-if="ruleForm.minsutupian" label="民宿图片" prop="minsutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.minsutupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="民宿简介" prop="minsujianjie">
          <el-input v-model="ruleForm.minsujianjie" 
              placeholder="民宿简介" clearable  :readonly="ro.minsujianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="民宿简介" prop="minsujianjie">
              <el-input v-model="ruleForm.minsujianjie" 
                placeholder="民宿简介" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.minsutupian = true;
            continue;
	            	            ...
	            	            if(o=='minsujianjie'){
            this.ruleForm.minsujianjie = obj[o];
	    this.ro.minsujianjie = true;
            continue;
          }
	            	            if(o=='thumbsupnum'){
