          ...
          <el-form-item class="input" label="天数" prop="tianshu">
              <el-input v-model="ruleForm.tianshu" 
                placeholder="天数" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="已收金额" prop="yishoujine">
            <el-input v-model="yishoujine"
                placeholder="已收金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yishoujine" label="已收金额" prop="yishoujine">
              <el-input v-model="ruleForm.yishoujine" 
                placeholder="已收金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
                                                                                    yishoujine:{
                                                                                                                                                                                                                                              get: function () {
        return 1*this.ruleForm.fangjianjiage*this.ruleForm.tianshu
      }
    },
                                                                                                              },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tianshu = true;
            continue;
	            	            ...
	            	            if(o=='yishoujine'){
            this.ruleForm.yishoujine = obj[o];
	    this.ro.yishoujine = true;
            continue;
          }
	            	            if(o=='tuidingshijian'){
	    ...
	    this.ro.shouji = true;
            continue;
                                                                                                                        ...
                                                                                                                        this.ruleForm.yishoujine = 0
	this.ro.yishoujine = false;
                                                                                                                                                      }
            // 获取用户信息
      this.$http({
    ...
    onSubmit() {
                  // ${column.compare}
                              ...
                              // ${column.compare}
                              // ${column.compare}
              this.ruleForm.yishoujine = this.yishoujine
                              // ${column.compare}
                              // ${column.compare}
                              // ${column.compare}
                              // ${column.compare}
      ...
      obj.yishoujine = obj.yishoujine - this.ruleForm.yishoujine
      if(obj.yishoujine<0){
        this.$message.error("已收金额不足");
        return
      }
      this.$http({
          url: `${table}/update`,
