          ...
          <el-form-item class="input" label="房间价格" prop="fangjianjiage">
              <el-input v-model="ruleForm.fangjianjiage" 
                placeholder="房间价格" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收取金额" prop="shouqujine">
          <el-input v-model="ruleForm.shouqujine" 
              placeholder="收取金额" clearable  :readonly="ro.shouqujine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收取金额" prop="shouqujine">
              <el-input v-model="ruleForm.shouqujine" 
                placeholder="收取金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                      </el-row>
